...
class GoodsCat extends service.Model {
  ...
  processParent() {
    ...
    return _asyncToGenerator(function* () {
      let parent = yield GoodsCat.findById(_this.parent);
      if (!parent) {
        return;
      }
  ...
  subs() {
    ...
    return _asyncToGenerator(function* () {
      if (_this2.populated('subCats')) {
        return _this2.subCats;
      }
      return yield GoodsCat.find({ parent: _this2._id });
    })();
  }
