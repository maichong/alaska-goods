...
function updateValue(value, goodsProps, goodsPropsMap) {
  value = value || [];
  var skuProps = [];
  _lodash2.default.forEach(goodsProps, function (prop) {
    if (prop.sku) {
      skuProps.push(prop);
    }
  });
...
function createPropsMap(props) {
  var map = {};
  _lodash2.default.forEach(props, function (p) {
    var item = _lodash2.default.assign({}, p);
    item.valueMap = {};
    _lodash2.default.forEach(p.values, function (v) {
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'th',
                  null,
                  t('Picture', 'alaska-goods')
                ),
                _react2.default.createElement(
                  'th',
                  null,
                  t('Properties', 'alaska-goods')
                ),
                _react2.default.createElement(
                  'th',
                  null,
                  t('Inventory', 'alaska-goods')
                ),
                _react2.default.createElement(
                  'th',
                  null,
                  t('Price', 'alaska-goods')
                ),
                _react2.default.createElement(
                  'th',
                  null,
                  t('Discount', 'alaska-goods')
                ),
